...
def Run_Training():
    ...
    memory = ReplayMemory(Config.replay_size, Config.seed, task_count=5, buffer_size=10)  # 작업 수를 5로 설정
    ...
    for i_episode in itertools.count(1):
        ...
        memory.push_task(task_id, episode_reward)
